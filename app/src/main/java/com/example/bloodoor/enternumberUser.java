...
public class enternumberUser extends AppCompatActivity {
                        ...
                        PhoneAuthProvider.getInstance().verifyPhoneNumber(
                                ...
                                new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
                                    ...
                                    public void onVerificationFailed(@NonNull FirebaseException e) {
                                        ...
                                        Toast.makeText(enternumberUser.this, "Network Error:(", Toast.LENGTH_SHORT).show();
                                    }
...
//                        startActivity(intent);
                        ...
                        Toast.makeText(enternumberUser.this, "Please enter correct number", Toast.LENGTH_SHORT).show();
                    }
                } else {
                    Toast.makeText(enternumberUser.this, "Enter Mobile Number", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
